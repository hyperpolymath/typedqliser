...
doctor:
    @echo "Running diagnostics for typedqliser..."
...
heal:
    @echo "Attempting auto-repair for typedqliser..."
...
help-me:
    @echo "=== typedqliser Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/typedqliser/issues/new"
    @echo ""
