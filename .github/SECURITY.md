...
Replace all {{PLACEHOLDER}} values with your information:
  TypedQLiser     - Your project name
  hyperpolymath            - GitHub username or org (e.g., hyperpolymath)
  typedqliser             - Repository name
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/typedqliser/security/advisories/new)
...
- This repository (`hyperpolymath/typedqliser`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/typedqliser/security/advisories)
...
When using TypedQLiser, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/typedqliser/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/typedqliser/security/advisories/new) or {{SECURITY_EMAIL}} |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/typedqliser/discussions) |
...
*Thank you for helping keep TypedQLiser and its users safe.* 🛡️
