...
// Replace typedqliser, Typedqliser — See README.adoc for details., just run, Typedqliser started successfully. with actuals
= typedqliser — Quick Start for Users
:toc:
:toclevels: 2

== What is typedqliser?

Typedqliser — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./typedqliser-portable
----
...
[source]
----
Typedqliser started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/typedqliser/wiki
